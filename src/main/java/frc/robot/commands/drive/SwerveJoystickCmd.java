...
public class SwerveJoystickCmd extends CommandBase {
        ...
        public void execute() {
                ...
                double x = xSpeed; // xSpeed * robotAngle.getCos() + ySpeed * robotAngle.getSin();
                double y = ySpeed; // xSpeed * robotAngle.getSin() + ySpeed * -robotAngle.getCos();
